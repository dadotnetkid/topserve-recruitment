...
namespace RecruitmentSystem.Controllers
{
    public class ManpowerSummaryReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ManpowerStatusSummaryExport(ManpowerStatusSummaryViewModel i)
        {
            ExportManpowerStatusViewModel export = new ExportManpowerStatusViewModel();
            var res = export.ExportManpowerSummaryReport(i.accountmanager, i.BranchId, i.datefrom, i.dateto);
            return File(res.ToArray(), "application/vnd.ms-excel", "Manpower Summary Report.xlsx");
        }
        ...
        /*  public ActionResult ManpowerStatusSummaryExport(ManpowerStatusSummaryViewModel i)
          {
              ExportManpowerStatusViewModel export = new ExportManpowerStatusViewModel();
              var res = export.ExportManpowerSummaryReport(i.accountmanager,i.datefrom,i.dateto);
