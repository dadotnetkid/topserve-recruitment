...
namespace RecruitmentSystem.Models
{
    public class ManpowerViewModel : Urls
    {
        ...
        public List<sp_recruiter_list_filter_branchResult> RecruiterList()
        {
            Branch = Branch == null ? "" : Branch;
            Search = Search == null ? "" : Search;
            return db.sp_recruiter_list_filter_branch(Branch, Search).ToList();
        }
        ...
        public List<SelectListItem> RecruiterListSearch()
        {
            var list = db.ExecuteQuery<Recruiter>("select * from view_recruiter_list" ).ToList();
