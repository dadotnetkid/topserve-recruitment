...
namespace RecruitmentSystem.Recruitment.Class
{
    public class ExportReport
    {
        ...
        public MemoryStream ExportManpowerReport(ManpowerStatusReportViewModel model)
        {
            ...
            {
                dt.Rows.Add(i.mrfid, i.DateRequested, i.company_name, i.branch, i.industry_name, i.position_name, i.SkillType, i.account_manager_1, i.account_manager_2,
                            ...
                            i.for_requirement, i.status, i.Remarks);
            }
        ...
        DataTable ManpowerStatusReportTemplate()
        {
            ...
            dt.Columns.Add("Account Manager 1");
            dt.Columns.Add("Accountmaner 2");
        ...
        public MemoryStream ExportManpowerSummaryReport(string am, DateTime? Dtfrom, DateTime? Dtto)
        {
            ...
            foreach (var i in db.sp_manpower_status_summary(am, "", Dtfrom, Dtto))
            {
                ...
                oncall += i.OnCall;
                totalrequirement += i.TotalRequirement;
                cancelled += i.CancelledRequirement;
                closed += i.Closed;
                pending += i.Pending;
                onprocess += i.OnProcess;
            }
            //  dt1.Rows.Add("", _new, replacement, oncall, totalrequirement, closed, pending, onprocess);
            //2 table
            decimal? ntr = 0;
            decimal? octr = 0;
            decimal? rtr = 0;
            ...
            foreach (var i in db.sp_manpower_status_summary_new_per_total_requirement(am, "", Dtfrom, Dtto))
            {
                ...
                //ntr += i.percent_new_total_requirement;
                //octr += i.percent_oncall_total_requirement;
                //rtr += i.percent_replacement_total_requirement;
                trtr += i.percent_total_requirement;
            }
            //   dt2.Rows.Add("", _new, _new / totalrequirement, oncall, oncall / totalrequirement, replacement, replacement / totalrequirement, totalrequirement, trtr);

            int? placement = 0;
            int? placement_onprocess = 0;
            foreach (var i in db.sp_manpower_status_summary_closed_per_total_requirement(am, "", Dtfrom, Dtto))
            {
                ...
                placement += i.Closed;
                placement_onprocess += i.PlacementAndOnProcess;
            }

            //  dt3.Rows.Add("", placement / totalrequirement, pending, pending / totalrequirement, onprocess, onprocess / totalrequirement, placement_onprocess, placement_onprocess / totalrequirement);
