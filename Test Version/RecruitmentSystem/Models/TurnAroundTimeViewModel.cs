...
namespace RecruitmentSystem.Models
{
    public class TurnAroundTimeViewModel
    {
        ...
        DataTable TurnAroundTimeDataTable()
        {
            ...
            var columns = new string[] { "MRFID", "REQUESTED", "APPROVED", "POSITION", "REQUIRED APPLICANT", "CLASSIFICATION", "TAT", "STATUS" };
        ...
        public MemoryStream DownloadTurnAroundTime()
        {
            ...
            {
                dt.Rows.Add(i.mrfid, i.DateRequested, i.am_date_approved, i.position_name, i.RequiredNumber - i.cancel_number_requirement, i.Classification, i.TAT, i.status);
            }
