...
namespace RecruitmentSystem.Models
{
    public class AgingReportViewModel
    {
        ...
        DataTable AgingReportDataTable()
        {
            ...
            var columns = new string[] { "MRFID", "REQUESTED", "APPROVED", "POSITION", "REQUIRED APPLICANT", "CLASSIFICATION", "BATTING RATIO", "AGING" };
        ...
        public MemoryStream DownloadAgingReport()
        {
            ...
            {
                dt.Rows.Add(i.mrfid, i.DateRequested, i.am_date_approved, i.position_name, i.RequiredNumber - i.cancel_number_requirement, i.Classification, Convert.ToDecimal(i.batting_ratio).ToString("N2"), i.aging_days);
            }
