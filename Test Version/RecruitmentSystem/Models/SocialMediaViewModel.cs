...
namespace RecruitmentSystem.Models
{
    public class SocialMediaViewModel
    {
        ...
        public string ManpowerDetails()
        {
            ...
            {
                retval = string.Format("Job Position:{0}, \n Education Attainment:{1}, \n Age Required:{2}, \n Gender:{3}, \n Recruiter Name:{4}, \n Recruiter Contact Number:{5}", i.position_name, i.EducationalAttainment, i.AgeRequirement, i.Gender, Users.Fullname(i.recruiter_id), i.recruiternumber);
            }
            return retval;
        }
    }
